...
public class CuMapFragment extends FragmentActivity implements OnMapReadyCallback {
                            ...
                            if(mLastKnownLocation!= null) {
                                ...
                                try {
                                    ...
                                    if (result.routes.length == 0) {
                                        Toast.makeText(CuMapFragment.this, "No route is found",
