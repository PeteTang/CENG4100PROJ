...
public class MapActivity3 extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(22.418162, 114.207344);
        ...
        LatLng UNISPORTS = new LatLng(22.417850, 114.210382);
        mMap.addMarker(new MarkerOptions().position(UNISPORTS).title("2. University Sports Centre"));

        LatLng SC = new LatLng(22.419816,114.207577);
        mMap.addMarker(new MarkerOptions().position(SC).title("3. Science Centre"));

        LatLng LKKC = new LatLng(22.419877,  114.203318);
        mMap.addMarker(new MarkerOptions().position(LKKC).title("4. Fung king-hey Building"));

        LatLng Res34 = new LatLng(22.421111,  114.203435);
        mMap.addMarker(new MarkerOptions().position(Res34).title("5. Residences 3 & 4"));

        LatLng Res34D = new LatLng(22.421185,  114.203486);
        mMap.addMarker(new MarkerOptions().position(Res34D).title("12. Residences 3 & 4"));

        LatLng Shaw = new LatLng(22.422443,  114.201209);
        mMap.addMarker(new MarkerOptions().position(Shaw).title("6/11.Shaw College"));

        LatLng CWC = new LatLng(22.425608,  114.206641);
        mMap.addMarker(new MarkerOptions().position(CWC).title("7. CWC"));

        LatLng Res15 = new LatLng(22.423654,  114.206434);
        mMap.addMarker(new MarkerOptions().position(Res15).title("8. Residence 15"));

        LatLng UCStaff = new LatLng(22.423190,  114.205305);
        mMap.addMarker(new MarkerOptions().position(UCStaff).title("9. United College Staff Residence"));

        LatLng CCHH = new LatLng(22.421891,  114.204757);
        mMap.addMarker(new MarkerOptions().position(CCHH).title("10. Chan Chun Ha Hostel"));
