...
public class MapActivity1B extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(MTR).title("1/8. MTR"));

        LatLng PGRAD = new LatLng(22.420360, 114.212146);
        mMap.addMarker(new MarkerOptions().position(PGRAD).title("2/7. Jockey Club Postgraduate Hall"));

        LatLng SHHO = new LatLng(22.417850, 114.210382);
        mMap.addMarker(new MarkerOptions().position(SHHO).title("3. University Sports Centre"));

        LatLng SRR = new LatLng(22.419865, 114.207020);
        mMap.addMarker(new MarkerOptions().position(SRR).title("4. Sir Run Run Shaw Hall"));

        LatLng ADM = new LatLng(22.418818, 114.205284);
        mMap.addMarker(new MarkerOptions().position(ADM).title("5. University Admin Building"));

        LatLng SHHOD = new LatLng(22.418033, 114.209908);
        mMap.addMarker(new MarkerOptions().position(SHHOD).title("6. SHHO College"));
